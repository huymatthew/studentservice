# Generated by Django 4.2.7 on 2025-07-29 09:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Đang học'), ('graduated', 'Đã tốt nghiệp'), ('suspended', 'Tạm nghỉ'), ('dropped', 'Thôi học')], default='active', max_length=20)),
